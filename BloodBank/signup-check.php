...
if (isset($_POST['uname']) && isset($_POST['password']) 
	...
	if (empty($uname)){
		...
		header("Location: signup.php?error=Password re-entry is required&$user_data");
		exit();
	}
		...
		header("Location: signup.php?error=The confirmation password is not match&$user_data");
		exit();
	}
